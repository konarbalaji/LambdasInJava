...
public class EmployeeTestUsingPredicateAnd {
    ...
    public static void main(String[] args) {
        ...
        //5. Java developer in EDC unit
        System.out.println("---------- 5. Java developer in EDC unit ----------");
        List<Employee> javaDevsInEdc = getAllEmployeesWithFilter(javaSkills.and(edcfiter));
