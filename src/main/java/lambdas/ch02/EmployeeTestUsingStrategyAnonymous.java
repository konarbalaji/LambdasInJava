...
public class EmployeeTestUsingStrategyAnonymous {
    ...
    public static void main(String[] args) {
        ...
        List<Employee> edcEmployees = getAllEmployeesWithFilter(new EmployeeFilter() {
            @Override
        ...
        List<Employee> fsEmployees = getAllEmployeesWithFilter(new EmployeeFilter() {
            @Override
            public boolean filterEmployee(Employee emp) {
        ...
        List<Employee> empWithJavaSkills = getAllEmployeesWithFilter(new EmployeeFilter() {
            @Override
            public boolean filterEmployee(Employee emp) {
        ...
        List<Employee> seniorEmployees = getAllEmployeesWithFilter(new EmployeeFilter() {
            @Override
            public boolean filterEmployee(Employee emp) {
