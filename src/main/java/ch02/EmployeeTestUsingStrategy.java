...
public class EmployeeTestUsingStrategy {
    ...
    public static void main(String[] args) {
        ...
        List<Employee> edcEmployees = getAllEmployeesWithFilter(new EDCFilter());
        ...
        List<Employee> fsEmployees = getAllEmployeesWithFilter(new FSFilter());
        ...
        List<Employee> empWithJavaSkills = getAllEmployeesWithFilter(new JavaSkillsFilter());
        System.out.println(empWithJavaSkills);

        //4.Get list of senior employees
        System.out.println("---------- 4.Get list of senior employees ----------");
        List<Employee> seniorEmployees = getAllEmployeesWithFilter(new SeniorEmployeeFilter());
